    ...
    <div className="pt-navbar flex flex-col w-[90%]" id="scrimba">
      ...
      <div className="flex justify-evenly flex-wrap">
        ...
        <ProjectCard
          ...
          deploymentLink="scrimbamoviewatchlist-production.up.railway.app"
        ...
        <ProjectCard
          ...
          deploymentLink="scrimbacolorscheme-production.up.railway.app"
        ...
        <ProjectCard
          ...
          deploymentLink="scrimbatraveljournal.railway.internal"
        ...
        <ProjectCard
          ...
          deploymentLink="scrimbapasswordgen-production.up.railway.app"
